...
clearTimeout(c);c=setTimeout(j,500)}).bind("mouseup."+h,function(a){d.publish(h+".windowmouseup",a)});var i={exampleExtension:function(a){this.events.subscribe(e+".initializing",function(){this.settings.hasOwnProperty("non-existent setting category?")&&console.log(a+" is here")})}},l={"default":function(){return this.toDataURL()},"native":function(a){return a},image:function(){var a=this.toDataURL();if("string"===typeof a&&4<a.length&&"data:"===a.slice(0,5)&&-1!==a.indexOf(",")){var b=a.indexOf(",");
return[a.slice(5,b),a.substr(b+1)]}return[]}},v={"native":function(a,b,c){c(a)},image:k,"image/png;base64":k,"image/jpeg;base64":k,"image/jpg;base64":k},m={"export":l,"import":v,instance:i},A={init:function(a){return this.each(function(){console.log("Initing jSignature");var b,c=!1;for(b=this.parentNode;b&&!c;)c=b.body,b=b.parentNode;!c||new s(this,a,i)})},getSettings:function(){return this.find("canvas."+e).add(this.filter("canvas."+e)).data(e+".this").settings},clear:p,reset:p,addPlugin:function(a,
b,c){m.hasOwnProperty(a)&&(m[a][b]=c);return this},listPlugins:function(a){var b=[];if(m.hasOwnProperty(a)){var a=m[a],c;for(c in a)a.hasOwnProperty(c)&&b.push(c)}return b},getData:function(a){var b=this.find("canvas."+e).add(this.filter("canvas."+e));void 0===a&&(a="default");if(0!==b.length&&l.hasOwnProperty(a))return l[a].call(b.get(0),b.data(e+".data"))},importData:b,setData:b,globalEvents:function(){return d},events:function(){return this.find("canvas."+e).add(this.filter("canvas."+e)).data(e+
